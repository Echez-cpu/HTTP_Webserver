<?php
    // dirname(dirname(__FILE__)) goes one directory up from there
    $file = dirname(dirname(__FILE__)) . '/d_struct/data.json'; // Locating the JSON File; __FILE__ is a magic constant in PHP that gives the full path to the current script.
